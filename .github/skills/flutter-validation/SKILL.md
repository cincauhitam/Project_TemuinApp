...
1. Check lutter --version to get the current SDK version
...
|---|---|---|
| Invented widget properties | lignment: CrossAxisAlignment.start | crossAxisAlignment: CrossAxisAlignment.start |
...
- Add a **Dependency Check** section listing all imported packages and their verification status
- Flag any APIs that could not be verified as TODO
- Include SDK version notes if the code may not be compatible with older Flutter versions
- Reference pub.dev or api.flutter.dev URLs for untested third-party integrations
